  ...
  const services = [
    {
      ...
      features: ["تصميم الابتسامة", "القشور الخزفية", "تبييض هوليوود"],
    },
    {
      icon: "✨",
      title: "تنظيف وتبييض الأسنان",
      description: "تنظيف عميق احترافي وتبييض لابتسامة مشرقة وصحية",
      features: ["تنظيف احترافي", "تبييض متقدم", "تلميع الأسنان"],
    },
  ]
